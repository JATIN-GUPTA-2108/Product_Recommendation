  ...
  <section className="about-us p-5">
    <div className="row">
      ...
      <div className="col-md-6 d-flex flex-column align-items-center justify-content-center">
        <h1 className='who-are-we'><b>Who are we?</b></h1>
    ...
    <div className="container-xxl">
      <div className="row">
        <div className="col-12 d-flex flex-column align-items-center">
          <h1 className='mb-3 customer-say'>What our customers say...</h1>
          ...
          <div className="row g-0">
            ...
            <div className="col-md-8">
              <div className="card-body">
                <h5 className="card-title">Mathew John</h5>
                ...
                <p className="card-text"><small className="text-body-secondary">Last updated 30 mins ago</small></p>
              </div>
              </div>
        ...
        <div className="col-12 col-md-6 p-3">
              <div className="card mb-3">
                <div className="row g-0">
                  ...
                  <div className="col-md-8">
                    <div className="card-body">
                      <h5 className="card-title">Scarlet Johnson</h5>
                      <p className="card-text mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit <br />. Doloribus maxime consequatur, ipsam architecto incidunt volup <br />tate! Iste ipsa numquam quos nam quibusdam perferendis excepturi rem, a quo laudantium libero dolore nisi.</p>
                      <p className="card-text"><small className="text-body-secondary">Last Updated 10 min ago</small></p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col-12 col-md-6 p-3">
              <div className="card mb-3">
                <div className="row g-0">
                  ...
                  <div className="col-md-8">
                    <div className="card-body">
                      <h5 className="card-title">Sunil Sharma</h5>
                      <p className="card-text mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit <br />. Doloribus maxime consequatur, ipsam architecto incidunt volup <br />tate! Iste ipsa numquam quos nam quibusdam perferendis excepturi rem, a quo laudantium libero dolore nisi.</p>
            ...
            <div className="col-12 col-md-6 p-3">
              <div className="card mb-3">
                <div className="row g-0">
                  ...
                  <div className="col-md-8">
                    <div className="card-body">
                      <h5 className="card-title">Sarthak Lakhera</h5>
                      <p className="card-text mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit <br />. Doloribus maxime consequatur, ipsam architecto incidunt volup <br />tate! Iste ipsa numquam quos nam quibusdam perferendis excepturi rem, a quo laudantium libero dolore nisi.</p>
                      <p className="card-text"><small className="text-body-secondary">Last Updated 4 hours ago</small></p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col-12 col-md-6 p-3">
              ...
              <div className="row g-0">
                ...
                <div className="col-md-8">
                  <div className="card-body">
                    <h5 className="card-title">Jack Ryan</h5>
                    <p className="card-text mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit <br />. Doloribus maxime consequatur, ipsam architecto incidunt volup <br />tate! Iste ipsa numquam quos nam quibusdam perferendis excepturi rem, a quo laudantium libero dolore nisi.</p>
